...
export class PhotosComponent implements OnInit {
  ...
  constructor(private httpclient:HttpClient,private store:Store<AppState>) {this.propertyId=store.select('propertyId') }
...
imgsrc:string="";
  ...
  public uploadFile(files:any)  {
   ...
   (propertyId: number) => {
      ...
      return this.httpclient.post("http://localhost:9095/api/photos",this.photo).subscribe((a:any)=>{this.load(formData);this.imgsrc=a.imageName;console.log(a)});
